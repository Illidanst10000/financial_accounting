                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-1 mb-3">
                            <a href="{{ route('user.earning.create') }}" class="btn btn-block btn-primary">Create</a>
                        </div>
                    </div>
                                        ...
                                        @foreach($earnings as $earning)
                                            <tr>
                                                ...
                                                <td class="text-center"><a
                                                        href="{{ route('user.earning.show', $earning->id) }}">
                                                        <i class="far fa-eye"></i>
                                                    </a></td>
                                                <td class="text-center"><a
                                                        href="{{ route('user.earning.edit', $earning->id) }}">
                                                        <i class="fas fa-pencil-alt text-success"></i>
                                                    </a></td>
                                                <td class="text-center">
                                                    <form action="{{ route('user.earning.delete', $earning->id) }}"
                                                          method="POST">
                                                        @csrf
                                                        @method('DELETE')
