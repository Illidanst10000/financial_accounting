                    ...
                    <div class="row ml-2">
                        <div class="col-md-6">
                            ...
                            <div class="card card-primary">
                                ...
                                <!-- form start -->
                                <form action="{{ route('user.earning.update', $earning->id) }}" method="POST">
                                    @method('PATCH')
                                    @csrf
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="type_id">
                                                @foreach($types as $type)
                                                    <option
                                                        value="{{ $type->id }}" {{ $type->id == $earning->type_id ? ' selected' : '' }}>
                                                        {{ $type->title }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="source_id">
                                                @foreach($sources as $source)
                                                    <option
                                                        value="{{$source->id}}" {{$source->id == $earning->source_id ? ' selected' : ''}}>
                                                        {{ $source->title }}
                                                    </option>
                                                @endforeach
                                            </select>
