                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-1 mb-3">
                            <a href="{{ route('admin.spending.create') }}" class="btn btn-block btn-primary">Create</a>
                        </div>
                    </div>
                                ...
                                <div class="card-body p-0">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><a href="{{ route('admin.spending.edit', $spending->id) }}">
                                                    <i class="fas fa-pencil-alt text-success"></i>
                                                </a></td>
                                            <td class="text-center">
                                                <form action="{{ route('admin.spending.delete', $spending->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
