                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-1 mb-3">
                            <a href="{{ route('admin.type.create') }}" class="btn btn-block btn-primary">Create</a>
                        </div>
                    </div>
                                ...
                                <div class="card-body p-0">
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td>{{$type->id}}</td>
                                            <td>{{$type->title}}</td>
                                            <td class="text-center"><a href="{{ route('admin.type.show', $type->id) }}">
                                                    <i class="far fa-eye"></i>
                                                </a></td>
                                            <td class="text-center"><a href="{{ route('admin.type.edit', $type->id) }}">
